...
class Server {
  ...
  listen() {
    this.server.listen(PORT, () => console.log(`El servidor esta escuchando en el puerto ${PORT}...`));
    mongoose.connect("mongodb+srv://villarrealjoaquin09:Mariogames10@cluster0.b98stds.mongodb.net/ecommerce?retryWrites=true&w=majority");
  }
}
